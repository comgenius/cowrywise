  ...
  return (
    <section className="bars-section">
          <div className="container">
            <div className="bars-section__content">
              <div className="grid flex-column p-t-20">
                <h2
                  className="xl"
                >
                  Get a
                ...
                <a href="https://cwry.se/app" className="button m-t-20">
              ...
              <div className="bars-section__animation">
                ...
                >
                  <div className="point-item-card">
                    ...
                    <p>
                      Invest in our diverse range of assets that grow in value
                      over time.
                    </p>
                  </div>
                </div>

...
import CowrywiseLogoBlue from "./svg/CowrywiseLogoBlue"
import CowrywiseLogoWhite from "./svg/CowrywiseLogoWhite"
import DownArrowNavbarMobile from "./svg/DownArrowNavbarMobile"
...
const Header = () => {
  ...
  const [isMobileActive1, setIsMobileActive1] = useState(false);
  const [isMobileActive2, setIsMobileActive2] = useState(false);
  const [isMobileActive3, setIsMobileActive3] = useState(false);
  ...
  const handleMobileButtonClick1 = () => setIsMobileActive1(!isMobileActive1);
  const handleMobileButtonClick2 = () => setIsMobileActive2(!isMobileActive2);
  const handleMobileButtonClick3 = () => setIsMobileActive3(!isMobileActive3);
  ...
  return (
    <nav className={`global-nav global-nav--transparent ${isScrolled ? 'global-nav--sticky' : ''}`}>
     
      <div className={`global-mobile-nav__menu`} style={{ height: isOpen ? '100.8vh' : '0px' }}>
        <ul className={`parent-list ${isOpen ? 'is-active' : ''}`}>
          <li>
            <button className={`${isMobileActive1 ? 'active' : ''}`} onClick={handleMobileButtonClick1}>
              Personal
              <DownArrowNavbarMobile/>
            </button>
            <div className={`nav__dropdown ${isMobileActive1 ? 'active' : ''}`}>
              <ul>
                <li>
                  <a href="#">
                    <svg
                ...
                <li>
                  <a href="#">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M93.45 35.17l-28.57-16.6L26.5 40.73l28.58 16.6.12 44.1 38.38-22.16-.13-44.1zM85.14 63.3A20.77 20.77 0 0183 70.69l2 1.13-1.37 2.36-1.94-1.1a21.311 21.311 0 01-5.37 5.85v3L74.37 83v-2.88a7.48 7.48 0 01-5.67.77L67 83.75 65.66 83l1.63-2.81A7.001 7.001 0 0164.85 75l-2.24 1.3v-2.22l2.24-1.29a21 21 0 012.41-7.94l-1.64-.93L67 61.56l1.66.95a20.5 20.5 0 015.66-5.77v-2.89l1.93-1.12v3a6.93 6.93 0 015.39-.36L83.55 52l1.37.78-2 3.39a7.21 7.21 0 012.16 4.92L88 59.43v2.23l-2.86 1.64z"
                        fill="#0067F5"
                      />
                      <path
                        d="M26.5 40.73l.13 44.1 28.57 16.6-.12-44.1-28.58-16.6z"
                        fill="#003781"
                      />
                      <path
                        d="M85.13 61.08A7.21 7.21 0 0083 56.16l2-3.39-1.45-.77-1.93 3.34a6.93 6.93 0 00-5.39.36v-3l-1.93 1.12v2.89a20.5 20.5 0 00-5.66 5.77L67 61.56l-1.37 2.36 1.64.93a21 21 0 00-2.41 7.94l-2.26 1.29v2.23L64.85 75a7 7 0 002.44 5.15L65.66 83l1.38.78 1.65-2.86a7.48 7.48 0 005.67-.77V83l1.94-1.11v-3a21.311 21.311 0 005.37-5.85l1.94 1.1L85 71.82l-2-1.13a20.77 20.77 0 002.13-7.39L88 61.66v-2.23l-2.87 1.65z"
                        fill="#fff"
                      />
                    </svg>
                    <div>
                      <span>Stash</span>
                      <span>A digital wallet for everything</span>
                    </div>
                  </a>
                </li>
              </ul>
              <div className="nav__dropdown__bottom">
                <ul>
                  <li>
                    <h6>Growth Tools</h6>
                  </li>
          ...
          <li>
            <button className={`${isMobileActive2 ? 'active' : ''}`} onClick={handleMobileButtonClick2}>
              Business
              <DownArrowNavbarMobile/>
            </button>
            <div className={`nav__dropdown ${isMobileActive2 ? 'active' : ''}`}>
              <ul>
                <li>
                  <a href="#">
                    <svg
          ...
          <li>
            <button className={`${isMobileActive3 ? 'active' : ''}`} onClick={handleMobileButtonClick3}>
              Developer
              <DownArrowNavbarMobile/>
            </button>
            <div className={`nav__dropdown ${isMobileActive3 ? 'active' : ''}`}>
              <ul>
                <li>
                  <a href="#" target="_blank" rel="noreferrer">
                    ...
                    <div>
                      <span>Embed</span>
                      <span>Offer investment services in your app</span>
                    </div>
                  </a>
                </li>
                <li>
        ...
        <ul className={`small-menu ${isOpen ? 'is-active' : ''}`}>
          <li>
        ...
        <div className="global-nav__row">
          ...
          <div className="global-nav__menu">
            ...
            <div className="global-nav__ctas">
              ...
              <Link to="/signup" className="button">Sign Up For Free</Link>
            </div>
            <div className="global-mobile-nav">
              <div className={`global-mobile-nav__trigger ${isOpen ? 'light is-active' : ''}`} onClick={() => setOpen(!isOpen)}>
                <span />
              </div>
            </div>
          </div>
